...
```kotlin
dependencies {
    implementation("com.boomstream:player-sdk:1.3.0")
    implementation("com.boomstream:api-sdk:1.3.0")
    implementation("com.boomstream:offline-sdk:1.3.0") // опционально — только если нужны offline-загрузки
}
```
...
```kotlin
implementation("com.boomstream:offline-sdk:1.3.0")
```
...
implementation("com.boomstream:player-sdk:1.3.0")
implementation("com.boomstream:api-sdk:1.3.0")
implementation("com.boomstream:offline-sdk:1.3.0") // optional
```
